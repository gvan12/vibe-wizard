...
**vibe-wizard** is a 3D web application built with viber3d, combining the power of React Three Fiber with the latest React 19 features. Created by Viber3D Developer.

## Description

A Viber3D game called vibe-wizard
